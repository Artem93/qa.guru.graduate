...
public class MobileTestBase {
    ...
    static void beforeAll() {
        Configuration.browser = switch (TypesMobileHostEnum.valueOf(ConfigsDriver.getSystemConfig().getDeviceHost().toUpperCase())) {
    ...
    void afterEach() {
        ...
        if (TypesMobileHostEnum.valueOf(ConfigsDriver.getSystemConfig().getDeviceHost().toUpperCase()).equals(BROWSERSTACK)) {
